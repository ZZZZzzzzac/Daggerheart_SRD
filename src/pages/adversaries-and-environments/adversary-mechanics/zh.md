## 敌人与环境 {#adversaries-and-environments}

## 使用敌人 {#using-adversaries}

## 敌人数据块 {#adversary-stat-blocks}
...
#### **敌人特性示例：** {#example-adversary-features}
...
## **构建平衡遭遇** {#building-balanced-encounters}
...
#### **被击败的敌人** {#defeated-adversaries}

当敌人标记最后的生命点时，即被击败：失去战斗能力、被绑缚、溃散、死亡，或由游戏桌上所有人共同决定的其他合理结果。

#### **敌人数据块基准** {#adversary-stat-block-benchmarks}
